...
class Pasta (models.Model):
    ...
    price_pasta = models.DecimalField(max_digits=5, decimal_places=4, blank=True)
...
class Subs (models.Model):
    ...
    tamanio = models.CharField(max_length=10, blank=True)
    price_subs = models.DecimalField(max_digits=5, decimal_places=4, blank=True)
    
class RegularPizza(models.Model):
    name_reg_pizza = models.CharField(max_length=30, blank=True)
    tamanio = models.CharField(max_length=10, blank=True)
    price_reg_pizza = models.DecimalField(max_digits=5, decimal_places=4, blank=True)
    quantity_top = models.IntegerField(max_length=1, blank=True, unique=True)
    toppings = models.ManyToManyField(Toppings)

class SicilianPizza(models.Model):
    name_sic_pizza = models.CharField(max_length=30, blank=True)
    tamanio = models.CharField(max_length=10, blank=True)
    price_sic_pizza = models.DecimalField(max_digits=5, decimal_places=4, blank=True)
    quantity_top = models.IntegerField(max_length=1, blank=True, unique=True)
    toppings = models.ManyToManyField(Toppings)
...
class SpecialRegularPizza(models.Model):
    ...
    tamanio = models.CharField(max_length=10, blank=True)
    price_special_reg = models.DecimalField(max_digits=5, decimal_places=4, blank=True)
    toppings = models.ManyToManyField(Toppings)

class SpecialSicilianPizza(models.Model):
    name_special_sic = models.CharField(max_length=40 ,default="Special Sicilian Pizza")
    tamanio = models.CharField(max_length=10, blank=True)
    price_special_sic = models.DecimalField(max_digits=5, decimal_places=4,blank=True)
    toppings = models.ManyToManyField(Toppings)

class Carrito(models.Model):
    items = models.CharField(max_length=100, blank=True)
    price_items = models.DecimalField(max_digits=6, decimal_places=4, blank=True)
